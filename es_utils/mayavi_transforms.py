# From: https://docs.enthought.com/mayavi/mayavi/auto/example_mlab_3D_to_2D.html
...
if __name__ == '__main__':
    ...
    X = np.random.randint(-3, 3+1, N)
    Y = np.random.randint(-3, 3+1, N)
    Z = np.random.randint(-3, 3+1, N)
